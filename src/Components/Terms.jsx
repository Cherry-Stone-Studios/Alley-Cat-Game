export function Terms() {
  return (
    <>
      ...
      <p>
        Cherry Stone Studios Games is licensed to You (End-User) by Cherry Stone
        Studios, located in the United States ("Licensor"), for use only under
      ...
      <p>
        ...
        as warranty, liability, maintenance and support thereof. Cherry Stone
        Studios, not the Services, is solely responsible for the Licensed
      ...
      <p>
        ...
        ("Usage Rules"). Cherry Stone Studios acknowledges that it had the
        opportunity to review the Usage Rules and this License Agreement is not
        conflicting with them.
      </p>
      <p>
        Cherry Stone Studios Games, when purchased or downloaded through the
        ...
        granted to You. Cherry Stone Studios Games is to be used on devices that
        operate with Google's operating system ("Android").
      </p>
      <ol>
        <li>
      ...
      <p>
        <b>Cherry Stone Studios Games</b> ("
        <b>Licensed Application</b>") is a piece of software created to
        <b>
          The Application was created to play Alley Cat to feed your stray cat
          character and outrun the hazards of the alleyways.
        </b>
        — and customized for
        <b>Android</b> mobile devices ("<b>Devices</b>"). It is used to
        <b>The Application's main use is to be fun to play!</b>.
      </p>
      <p>
        You’ll need a Cherry Stone Studios Games account to access many of our
        services. To create an account and use the Cherry Stone Studios
        Services, you must: (i) be an adult; (ii) be an emancipated minor; or
        (iii) have valid parent or legal guardian consent to be bound by these
        Terms. If you’re not an adult or emancipated minor, or don’t understand
        this Section, please talk to your parents or legal guardian and ask for
        help. If you are the parent or legal guardian of a minor who creates an
        account with us, you and the minor accept and agree to be bound by these
        Terms. You are also responsible for all use of the account and
        compliance with these Terms by the minor, including all purchases made
        on the account. You may not create or use an account or use any of the
        Cherry Stone Studios Services on behalf of any other person or other
      ...
      <p>
        2.2 This license will also govern any updates the will also govern any
        updates of the Licensed Application provided by Licensor that replace,
        repair, and/or supplement the first Licensed Application, unless a
        separate license is provided for such update, in which case the terms of
      ...
      <p>
        ...
        Cherry Stone Studios's prior written consent), sell, rent, lend, lease
      ...
      <p>
        ...
        Application, or any part thereof (except with Cherry Stone Studios's
      ...
      <p>
        3.1 The Licensed Application requires a firmware version 1.0 or higher.
      ...
      <p>
        4.2 Cherry Stone Studios and the End-User acknowledge that the Services
      ...
      <p>
        ...
        Your legal agreements with Licensor and Licensor's privacy policy, which
        can be found at the bottom of the Licensed Application.
      </p>
      <p>
      ...
      <p>
        ...
        outside of Cherry Stone Studios's sphere of influence that affect the
        executability of the Licensed Application.
      </p>
      <p>
        9.3 You are required to inspect the Licensed Application immediately
        after installing it and notify Cherry Stone Studios about issues
      ...
      <p>
        9.4 If we confirm that the Licensed Application is defective, Cherry
        Stone Studios reserves a choice to remedy the situation either by means
      ...
      <p>
        ...
        Licensed Application, and any other losses, claims, damages,
        liabilities, expenses, and costs attributable to any negligence to
        adhere to any warranty.
      </p>
      <p>
        If the user is an entrepreneur, any claim based on faults expires after
        a statutory period of limitation amounting to twelve (12) months after
        the Licensed Application was made available to the user. The statutory
      ...
      <p>
        ...
        Studios, and not the Services, is responsible for addressing any claims
      ...
      <p>
        The license is valid until terminated by Cherry Stone Studios or by You.
        Your rights under this license will terminate automatically and without
        notice from Cherry Stone Studios if You fail to adhere to any term(s) of
      ...
      <p>
        Cherry Stone Studios represents and warrants that Cherry Stone Studios
      ...
      <p>
        ...
        Developer's End-User License Agreement," Google's subsidiaries shall be
      ...
      <p>
        Cherry Stone Studios and the End-User acknowledge that, in the event of
        ...
        party's intellectual property rights, Cherry Stone Studios, and not the
