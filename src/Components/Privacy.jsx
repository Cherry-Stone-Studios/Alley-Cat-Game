  ...
  return (
    <>
      ...
      <p>
        ...
        hereinafter " <b>Personal Information</b> ") is necessary for the
      ...
      <p>
        ...
        We are not aware of the identity of a User from which the Non-personal
      ...
      <ul>
        <li>
          Device Information: We collect Personal Information from your device.
          Such information includes geolocation data, IP address, unique
          identifiers (e.g. MAC address and UUID) and other information which
          relates to your activity through the Site
        </li>
        <li>
          Your Contact information: When you contact us through our Site you
          will be asked to provide us certain details such as: full name; e-mail
          or physical address, and other information.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Conducting statistical and analytical purposes, intended to improve
          the Site.
        </li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>
          Providing you with marketing offers and promotional materials related
      ...
      <ol>
        ...
        <li>
          'persistent cookies ' - These are read only by the Site, saved on your
        ...
        <li>
          'third party cookies' - These are set by other online services who run
      ...
      <p>
        ...
        about your use of the Site. Google Analytics collects information such
        as how often users access the Site, what pages they visit when they do
        so, etc. We use the information we get from Google Analytics only to
        improve our Site and services. Google Analytics collects the IP address
        ...
        identifiable information. Google’s ability to use and share information
        collected by Google Analytics about your visits to this Site is
        restricted by the Google Analytics
      ...
      <p>
        ...
        Site and your information. We employ industry standard procedures and
        policies to ensure the safety of the information we collect and retain,
        and prevent unauthorized use of any such information, and we require any
        third party to comply with similar security requirements, in accordance
        with this Privacy Policy. Although we take reasonable steps to safeguard
        information, we cannot be responsible for the acts of those who gain
        unauthorized access or abuse our Site, and we make no warranty, express,
      ...
      <p>
        We may use a third-party advertising technology to serve advertisements
        when you access the Site. This technology uses your information with
        regards to your use of the Services to serve advertisements to you
        (e.g., by placing third-party cookies on your web browser).
      </p>
      <p>
        ...
        the Digital Advertising Alliance ("DAA"). For more information about
        this practice by NAI and DAA members, and your choices regarding having
        this information used by these companies, including how to opt-out of
      ...
      <p>
        ...
        should contact us at cherry.stone.studios.games@gmail.com
      </p>
